...
public:
    ...
    /** @brief %Check Hidden Channel */
    void checkHiddenChannel();

    /** @brief %Check some MemoryLeak problems*/
...
private:
    ...
    void unFormatStringError(const Token *tok);
    void FileOpError(const Token *tok);
